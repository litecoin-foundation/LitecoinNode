...
LITECOIN_VER_NO_BIT="litecoin-0.13.2"
...
LITECOIN_DL_URL_ARCH64="https://download.litecoin.org/litecoin-0.13.2/linux/litecoin-0.13.2-aarch64-linux-gnu.tar.gz" #litecoin arch64 download link - EXPERIMENTAL
